...
// Função para pingar o servidor a cada 10 minutos para mantê-lo ativo
setInterval(() => {
  axios.get("http://localhost:3000") // Certifique-se de que a URL está correta para o seu servidor
    .then(response => {
